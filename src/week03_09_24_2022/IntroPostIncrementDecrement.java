...
public class IntroPostIncrementDecrement {
    ...
    public static void main(String[] args) {
        ...
        int b = 10;
        System.out.println(b--);//10 first do action(print) we will print 10
                               // and then change the value to 9
        System.out.println(b--);//9, i will print 9 and decrement it will
                                //be 8 for the next statement
