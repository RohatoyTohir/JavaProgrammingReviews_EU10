...
public class SumTwoNumber {
    public static void main(String[] args) {
        /*
        Create a class named SumTwoNumber, write a Java program to print the sum of two numbers
                 */
        ...
        //first number + second number =sum (value)
        ...
        //automatically assign for windows alt+enter+enter, for maC users
        //option+enter+enter
